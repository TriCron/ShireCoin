 ...
 *  A CTxDestination is the internal data type encoded in a shirecoin address
 */
...
/**
 * Generate a Shirecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
