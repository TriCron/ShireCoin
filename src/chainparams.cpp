...
{
    const char* pszTimestamp = "The Times Online 20/Jan/2021 Biden begins a new day in America";
    const CScript genesisOutputScript = CScript() << ParseHex("04a2ce1d3294f8ca93f1bd2ea2bc6b9bae1dcca048aedf1b3c52ae6ef514380249336e5b5a983d4360cd7d2c2cc610621506fa44b5b34acae9c5ccc2c13ea605c0") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP16Exception = uint256S("0x000000007c6afe197e7415bc0c3d492fb81ffa0095400045d3cff37f2492f617");
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = uint256S("0x000000007c6afe197e7415bc0c3d492fb81ffa0095400045d3cff37f2492f617");
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000007c6afe197e7415bc0c3d492fb81ffa0095400045d3cff37f2492f617"));
        assert(genesis.hashMerkleRoot == uint256S("8af41625a612ebacbcd02f831afe3762ff54cd4ce1fade6583bf60332fcc1a81"));
        ...
        vSeeds.emplace_back("uk1.shirecoin.org"); // UK
        vSeeds.emplace_back("ca1.shirecoin.org"); // Canada
        vSeeds.emplace_back("sg1.shirecoin.org"); // Singapore
        ...
        checkpointData = {
            {
                { 0, uint256S("0x000000007c6afe197e7415bc0c3d492fb81ffa0095400045d3cff37f2492f617")},
                { 100, uint256S("0x000000008a0094dfba326ee92c8aa4f72acc473c954348ac4dd52edc65d379e6")},
            }
        };

        chainTxData = ChainTxData{ 
            // Data from RPC: getchaintxstats 355 0000000004a7cdeead44d30ec6a4b918401e567770b302120d9444d1decc6962
            /* nTime    */ 1611686931,
            /* nTxCount */ 357,
            /* dTxRate  */ 0.003163090740608739,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        checkpointData = {
            {
                {0, uint256S("000000007c6afe197e7415bc0c3d492fb81ffa0095400045d3cff37f2492f617")},
            }
        };
