...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ShirecoinUnits::SeparatorStyle separators=ShirecoinUnits::separatorStandard) const;
