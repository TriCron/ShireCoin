...
//! Entry point for ShirecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ShirecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ShirecoinGUI tests.
void AppTests::guiTests(ShirecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ShirecoinGUI::consoleShown, this, &AppTests::consoleTests);
