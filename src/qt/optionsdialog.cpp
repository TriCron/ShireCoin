    ...
    mapper(nullptr)
{
    ...
    ui->shirecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->shirecoinAtStartup);
    ...
    ui->shirecoinAtStartup->setToolTip(ui->shirecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->shirecoinAtStartup->setText(ui->shirecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openShirecoinConfButton->setToolTip(ui->openShirecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ShirecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->shirecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openShirecoinConfButton_clicked()
{
