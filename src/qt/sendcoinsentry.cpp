    ...
    platformStyle(_platformStyle)
{
    ...
    // normal shirecoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying shirecoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ShirecoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
