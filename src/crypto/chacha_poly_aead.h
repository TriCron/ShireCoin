...
/* A AEAD class for ChaCha20-Poly1305@shirecoin.
 *
 ...
 *
 * The chacha20-poly1305@shirecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@shirecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@shirecoin are relatively fast in
