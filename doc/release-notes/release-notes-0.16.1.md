Shirecoin Core version 0.16.1 is now available from:

  <https://www.shirecoin.org/bin/shirecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting shirecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure shirecoind processes are cleaned up when tests end (sdaftuar)
