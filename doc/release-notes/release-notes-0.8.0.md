Shirecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/shirecoin/files/Shirecoin/shirecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Shirecoin
...
New/changed settings (command-line or shirecoin.conf file)
--------------------------------------------------------
