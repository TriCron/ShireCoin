Shirecoin Core version 0.9.2.1 is now available from:

  https://www.shirecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SHIRE to 0.01 SHIRE
...
- Fix "Start shirecoin on system login"
