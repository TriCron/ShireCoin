Shirecoin Core version 0.10.4 is now available from:

  <https://www.shirecoin.org/bin/shirecoin-core-0.10.4/>
...
- #6953 `43c2789` Split shirecoin-tx into its own package
- #6953 `dfe0d4d` Include shirecoin-tx binary on Debian/Ubuntu
