Shirecoin Core version 0.13.2 is now available from:

  <https://www.shirecoin.org/bin/shirecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update shirecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow shirecoin-tx to create v2 transactions (shiredrak)
