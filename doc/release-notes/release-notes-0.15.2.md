Shirecoin Core version *0.15.2* is now available from:

  <https://www.shirecoin.org/bin/shirecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in shirecoin-tx (TheBlueMatt)
