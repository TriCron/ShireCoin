...
Shirecoin Core version 0.19.1 is now available from:
  ...
  <https://www.shirecoin.org/bin/shirecoin-core-0.19.1/>
...
From Shirecoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Shirecoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Shirecoin Core does not yet change appearance when
...
- #17488 fix "shirecoind already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/shirecoin/shirecoin/).
