...
This document provides guidelines for internationalization of the Shirecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `shirecoin_en.ts` remains unchanged.
