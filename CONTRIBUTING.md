Contributing to Shirecoin Core
============================

The Shirecoin Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/tricron/shirecoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Shirecoin Core PR Review Club](https://shirecoincore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Shirecoin Core development happens on IRC, in the
#shirecoin-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/shirecoin-core-dev/](http://www.erisian.com.au/shirecoin-core-dev/)
and [http://gnusha.org/shirecoin-core-dev/](http://gnusha.org/shirecoin-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/shirecoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to shirecoin-qt
...
[Translation Process](https://github.com/tricron/shirecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Shirecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Shirecoin
Network Protocol consensus changes.

Whether a pull request is merged into Shirecoin Core rests with the project merge
...
Patches that change Shirecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Shirecoin consensus, it must have been
...
https://github.com/tricron/shirecoin/pull/16189).

Also see the [backport.py script](
https://github.com/shirecoin-core/shirecoin-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Shirecoin Core release.
