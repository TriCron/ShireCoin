...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the shirecoin repository."
  exit 1
fi
...
# See https://github.com/tricron/shirecoin/issues/16064
...
echo 'When compiling shirecoind, run `./configure` in the following way:'
echo
