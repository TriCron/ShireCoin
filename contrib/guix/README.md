# Bootstrappable Shirecoin Core Builds

This directory contains the files necessary to perform bootstrappable Shirecoin
Core builds.
...
- 24GB of free disk space on the partition that the Shirecoin Core git repository
  resides in
...
For a Shirecoin Core depends development environment, simply invoke
...
From the top of a clean Shirecoin Core repository:
...
To use dongcarl's substitute server for Shirecoin Core builds after having
