...
class TestShell:
    """Wrapper Class for ShirecoinTestFramework.

    The TestShell class extends the ShirecoinTestFramework
    ...
    class __TestShell(ShirecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ShirecoinTestFramework child class.
            self.num_nodes = 1
