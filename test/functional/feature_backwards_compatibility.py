...
from test_framework.test_framework import ShirecoinTestFramework, SkipTest
...
class BackwardsCompatibilityTest(ShirecoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.shirecoind,
            self.options.shirecoind,
            releases_path + "/v0.19.0.1/bin/shirecoind",
            releases_path + "/v0.18.1/bin/shirecoind",
            releases_path + "/v0.17.1/bin/shirecoind"
        ], binary_cli=[
            self.options.shirecoincli,
            self.options.shirecoincli,
            releases_path + "/v0.19.0.1/bin/shirecoin-cli",
            releases_path + "/v0.18.1/bin/shirecoin-cli",
            releases_path + "/v0.17.1/bin/shirecoin-cli"
        ])
    ...
    def run_test(self):
        ...
        node_v17.assert_start_raises_init_error(["-wallet=w3_v18"], "Error: Error loading w3_v18: Wallet requires newer version of Shirecoin Core")
        node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of Shirecoin Core")
