...
By default, shirecoind will dump mempool on shutdown and
...
class MempoolPersistTest(ShirecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent shirecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
