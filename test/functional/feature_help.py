...
"""Verify that starting shirecoin with -h works as expected."""

from test_framework.test_framework import ShirecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ShirecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shirecoin with -h for help text")
        ...
        self.log.info("Start shirecoin with -version for version information")
        ...
        self.log.info("Start shirecoind with -fakearg to make sure it does not start")
