...
class P2PPermissionsTests(ShirecoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].shirecoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].shirecoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
